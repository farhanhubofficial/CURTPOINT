...
import AboutImage from './Images/Approach.jpg'
import { Link } from 'react-router-dom'
import { FaChevronRight } from "react-icons/fa6";
import CurtApproach from './Images/striped-linen-curtains.jpg'

function Approach() {
  return (
    <div className='w-[94%] bg-slate-200 '>
<div className='w-[100%] h-[36rem] relative'>
  <img src= {AboutImage} alt=""  className='w-[100%] h-[36rem]  '/>
